    ...
    <section className='w-full min-h-screen bg-black pt-10 pl-5 pr-5 pb-10 lg:p-20 flex flex-col relative overflow-hidden'>
        <div className='lg:border border-white/12 w-full h-full border-r- border-b-transparent border-t-transparent lg:pl-10 lg:pr-10 gap-10 flex flex-col'>
            ...
            <div className='flex flex-col lg:flex-row w-full items-center gap-5'>
                <div className='w-full lg:w-[60%] h-[50vh] overflow-hidden flex flex-col items-center justify-center bg-white/2 group/card relative backdrop-blur-sm border border-t-white/20 border-l-white/20 border-b-white/5 border-r-white/5 rounded-3xl'>
                    ...
                    <div className='flex flex-row w-full items-center justify-center absolute bottom-5 group'>
                        <Link href={"/projects"} className='uppercase w-[70%] flex justify-center items-center overflow-hidden pt-7 pb-7 lg:pt-12 lg:pb-12 lg:w-1/2 2xl:pt-15 2xl:pb-15 text-3xl text-center bg-[#F54927] group-hover:bg-[#F54927]/70 rounded-full relative'>
                        ...
                        <div className='p-3 lg:p-7 2xl:p-10 rounded-full bg-[#F54927] group-hover:bg-[#F54927]/70'><ArrowUpRight size={40} className='transition-all duration-300 cubic-bounce group-hover:scale-125 group-hover:rotate-45'/></div>
                    </div>
                </div>
                <div className='w-full lg:w-[40%] h-[50vh] bg-[#F54927] rounded-3xl relative overflow-hidden flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-row w-full items-center justify-center absolute bottom-5 group'>
                        <Link href={"/projects"} className='uppercase justify-center items-center flex overflow-hidden w-[70%] 2xl:w-[70%] pt-7 pb-7 lg:pt-10 lg:pb-10 lg:w-1/2 2xl:p-15 text-black text-3xl text-center bg-white group-hover:bg-white/90 rounded-full relative'>
                            <span className='absolute transition-all duration-300 cubic-bounce group-hover:-translate-y-[350%]'>
                                projects
                            </span>
                            <span className='absolute translate-y-[350%] transition-all duration-300 cubic-bounce group-hover:translate-y-0'>
                        ...
                        <div className='p-3 lg:p-5 2xl:p-10 rounded-full bg-white group-hover:bg-white/90 text-black'><ArrowUpRight size={40} className='transition-all duration-300 cubic-bounce group-hover:scale-125 group-hover:rotate-45'/></div>
                    </div>
                </div>
            </div>
        </div>
