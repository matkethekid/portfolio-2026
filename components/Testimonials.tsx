...
const Testimonials = () => {
  ...
  return (
    <section className='w-full min-h-screen lg:pl-20 lg:pr-20 lg:pt-10 lg:pb-10 flex flex-col relative overflow-hidden'>
        <div className="md:rounded-[40px] bg-[#F54927] pt-5 pb-5 pl-5 pr-5 lg:pt-10 lg:pb-10 sm:w-full">
